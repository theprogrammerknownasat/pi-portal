...
print_info "Adding user to audio group for sound support..."
...
print_warning "1. Reboot the system to test the configuration"
print_warning "2. Pair this client with your Sunshine/GameStream server"
print_warning "3. Test the gaming session end-to-end"
echo ""
